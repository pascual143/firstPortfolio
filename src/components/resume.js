					...
					<body style={{ display: 'flex' }}>
						<div>
							<Cell
								...
								col={12}
								style={{ background: 'white', borderRadius: '15px', margin: '0 10px 10px 0' }}
							>
								<h2>Education</h2>
								<Education schoolName="GENERAL ASSEMBLY LONDON" startYear={2019} endYear={2019} />
								<Education schoolDescription="Inmerse course building rich, interactive, full-stack apps with key languages and diving into algorithms, data structures, design patterns, APIs, and more. Here some of the softwares learned" />
								<Education
								...
								/>
								<Education schoolDescription="Manager Packages: " schoolDescription1="npm, yarn" />
								<Education
								...
								/>
								<Education schoolDescription="Photography" />
								<Education
								...
								/>
								<Education schoolDescription="Manager Packages: " schoolDescription1="npm, yarn" />
								<Education schoolDescription="Testing: " schoolDescription1="Mocha, Chai" />
								<Education
									schoolDescription="Graphic Designer: "
									schoolDescription1="Photoshop, InDesign, Illustrator, Freehand, Animate CC"
								/>
								...
								<div className="resume-right-col" style={{ margin: 'auto 170px' }}>
									<Button
										...
										target="_blank"
										style={{ margin: '0px 30px 0px 30px', background: 'lightblue' }}
									>
										LiveDemo
									</Button>
									<Button
										colored
										href="https://github.com/pascual143/clyma"
										target="_black"
								...
								<div className="resume-right-col" style={{ margin: 'auto 170px' }}>
									<Button
										colored
										href="https://weather-3e996.firebaseapp.com/"
										rel="noopener noreferrer"
										target="_blank"
										style={{ margin: '0px 30px 0px 30px', background: 'lightblue' }}
									>
									...
									<Button
										colored
										href="https://github.com/pascual143/weather/tree/master/weather-master"
										target="_black"
										style={{ background: 'lightblue' }}
									>
										GitHub
								...
								<div className="resume-right-col" style={{ margin: 'auto 170px' }}>
									<Button
										colored
										href="https://connect-4-c9ed2.firebaseapp.com/"
										target="_blank"
										style={{ margin: '0px 30px 0px 30px', background: 'lightblue' }}
									>
										LiveDemo
									...
									<Button
										colored
										href="https://github.com/pascual143/WDI-Project-1"
										target="_blank"
										style={{ background: 'lightblue' }}
									>
										GitHub
              ...
              <img
                ...
                style={{height: '200px'}}
                 />
								...
								<h4 style={{ color: 'grey' }}>
									Software Development, Front-End, Back-End, Web Designer{' '}
								</h4>
								<hr style={{ borderTop: '3px solid #833fb2', width: '100%' }} />
								<p style={{ color: 'white' }}>
									Creative and ambitious seeking to apply knowledge in JavaScript UI technologies –
									REACT, Next, NodeJs, GraphQl - and creating RESTful web services to make a direct
									impact on the company’s business and clients. After gaining experience in Junior Web
									Developer hunting for another challenges and looking to find the industry role as a
								...
								<p />
								<a href="./assets/PascualVilaCVOn.pdf" download="./assets/PascualVilaCVOn.pdf">
									PDF Curriculum Vitae
								</a>
								<p />
								<a href="./assets/PascualVilaCVSpn.pdf" download="./assets/PascualVilaCVSpn.pdf">
									PDF Curriculum Vitae in Spanish
								</a>
								<hr style={{ borderTop: '3px solid #833fb2', width: '100%' }} />
							</Cell>
						</div>
